...
export const netWorklist: Array<NetWorkData> = [
    { value: 'erbie',color:'rgb(14, 126, 33)',icon: chessIcons[0], label: "Erbie", select: true ,URL, chainId: 51888, currencySymbol: 'ERB', browser:'http://www.erbiescan.com',transactionList:{},tokens:{} ,id: 'wormholes-network-1', isMain: true },
]