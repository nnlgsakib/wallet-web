export default {
  wallet: {
    ...
    loading: "Loading...",
    transactionRecord:
      "Transaction has been submitted.Please waite for a moment.",
    ...
    haveNoMoney:
      "Please make sure you have enough money in your wallet to try again !",
    access: "Access",
    ...
    selectSNFT: "You have not selected any CSBT",
    buySnft: "Do you have CSBT? {link}",
    findMore: "Find More",
    snftUnfree: "The SNFT of this pledge has not been unfrozen!",

    conver_approve:
      "The request is approved.The convert tansaction will be started.Please wait for seconds.",
    conver_waiting:
      "{count} <span style='color:#9F54BA;'>SNFT{countstr}</span> are being exchanged. You will receive {amount}<span style='color:#9F54BA;'>ERB</span> if you are successfully exchanged. You can also check the exchange details in the history of the Personal Center",
    conver_success:
      "{count} <span style='color:#9F54BA;'>SNFT</span> have been successfully exchanged and you have obtained {amount}<span style='color:#9F54BA;'>ERB</span>. You can also check the exchange details in the history of the Personal center",
    conver_wrong:
      "{count} SNFT failed to exchange, you can check the exchange details in the Personal center history",
  },
  bootstrapwindow: {
    ...
    wormHolesMessage:
      "Welcomed to Erbie. We’ve prepared some tips to get you started quickly.",
    wormHolesMessageEnd:
      "Congratulations on your start to a wonderful journey on Erbie!",
    accout: "Accout",
    accountMessage:
    ...
    sNFTs: "CSBT",
    sNFTsMessage: "View,Add,Transfer,Exchange CSBT",
    exchange: "EXCHANGE",
    exchangeMessage: "Automatic opening of exchange",
    identifier: "Identifier",
    identifierMessage: "Identity display ID (Validator&Exchange)",
    setUp: "SetUp",
  ...
  converSnft: {
    ...
    iconmeTip:
      "This is the estimated annual profit you will get after SNFT staking",
    periodTip:
      "During this period,you will not be allowed redeeming your SNFT back",
  },
  common: {
    ...
    addressnotfound:
      "The address cannot be found, please import the account first",
    ...
    exchange_pledge:
      "You need to pledge a minimum of 350ERB to become a staker. you will have the opportunity to get block subsidy of blockchain.  ",
    no_data: "No Data",
    ...
    back: "Back",
    year: "/Year",
    aftertheexchangeisclosed:
      "All data will be cleared after the staker is closed",
    yes: "Yes",
    no: "No",
    confirmthechanges: "Confirm the changes",
    suretomodifytheexchangepledgeamountcustodyservicefee:
      "Are you sure to modify the staker pledge amount/custody service fee?",
    ...
    connectTxt: "Connect",
    installMetaMask:
      "You do not have wallet installed, please install MetaMask first",
    ...
    moveDataTit: "Hint",
    moveTip:
      "The wallet data needs to be manually restored due to the version update. Are you sure to restore the wallet data of the old version to this wallet?",
    ...
    guideBtnTip:
      "Your digital wallet data is only saved on your browser's local storage; be sure to create a backup to avoid potential permanent losses. Uninstalling your browser and/or clearing your browser data will also potentially result in permanent losses!",
    asyncData: "Data synchronization, please wait.",
    convertAmount: "Convert amount",
    loadingWait: "Loading, please wait!",
    noMoney:
      "Your account is short of assets. Please make sure you have enough money in your wallet",
    recovery: "Recovery",
    gasSpeedUp: "Gas Speed Up",
    sendTipPendding:
      "There is an uncompleted transaction in the current transaction queue, please try again after completion!",
    speedUp: "Speed Up",
    toggleAddress: "Please switch your wallet account to this address first!",
    snftColorTip:
      "SNFT grades are L0, L1, L2, and L3 from the lowest to the highest. You can synthesize it to higher levels for higher revenue. The rules are as below: 16 specific SNFT L0 synthesizes a unique SNFT L1, 16 specific SNFT L1 synthesizes a unique SNFT L2, and 16 specific SNFT L2 synthesizes a unique SNFT L3. The blue number indicates the SNFT L0 position number in an SNFT L1.  The green number indicates the position number of SNFT L1 in an SNFT L2.  The yellow number indicates the SNFT L2 position number in an SNFT L3, and the red number refers to the position number of an SNFT L3.",
    contrctTx: "Transaction of contract",
    contractAddr: "Address of contract",
    converTip:
      "Tips: After the SNFT exchange is successful, it will disappear from the wallet. You can view the exchange record in the wallet's transaction history or browser.",
    snftLabel: "Convert CSBT ",
  ...
  creatorSnft: {
    ...
    totalProfit:
      "Creator continuously receives 10% of the total amount of the royalty trading quota",
    totalTimes:
      "The total number of times you were successfully elected as Creator",
    totalAward:
      "Creator, as the initiator of the transaction, directly gets the sum of the rewards in each period",
  ...
  castingnft: {
    ...
    collectionIntroductionPlaceholder:
      "4-60 characters, Chinese. English. Numbers.",
    royalty: "Royalty",
    ...
    namepopover:
      "can trigger key associations and enrich the audience experience~",
    namepopover2: "A good name ",
    descpopover:
      "Introduce your work, let more people understand the value of TA~",
  ...
  generateNFT: {
    ...
    promptTip1:
      "By AI: Input the prompt or description you want to depict, select the AI mode, and pay a certain ERB fee. AI will create the NFT content specifically for you and send it to your email.",
    promptTip2:
      "By URL: Input the URL of the existing NFT content, which can be sourced from platforms like OpenSea that can read image information.",
    promptTip: "You can mint chain-layer NFTs in two ways:",
    placeholder:
      'Prompts Word: Please enter text to describe the picture, for example: draw a sea tang in the style of Vermeer\'s "Girl with a Pearl Earring"  \nimage source URL: Asset URL(Length not greater than 112)',
    promptWordErr:
      "A maximum of 70 words can be entered, and only English slang and special symbols or url addresses are supported",
    promptWordIsSensitive:
      'Your prompt word involves sensitive words, please modify it before submitting."{words}"',
    promptWordNotNull: "The Prompts word / Image source URL cannot be empty",
    normalNftTip:
      "You have checked AI painting, please fill in valid prompts words, enter up to 70 words, only English is supported slang and special symbols.",
    ...
    aiDrawTip:
      "After entering the AI prompts word and selecting this mode, AI will create an NFT for you. This requires a small ERB fee, with {money} ERB being the testing standard during the testnet phase.",
    emailTip:
  ...
  send: {
    ...
    sendtofriends:
      "Send this link to a friend and he/she will ask them to send 88088ETH",
    ...
    approveMessage:
      "You can also view the details of the request through the transaction history.",
    successMessage:
      "Your transaction has been successfully sent, please view the details on the transaction history page",
    wattingMessage:
      "Transfer is in progress. This process may take more than ten seconds",
    failMessage:
      "I'm very sorry that the operation failed due to some accidents. You can check the specific information of the transaction in the transaction history",
  },
  transactiondetails: {
    status: "Status",
    send: "send",
  ...
  import: {
    ...
    announcement:
      "The imported account is viewable in your wallet but cannot be retrieved through the Erbie secret recovery.",
    learnmore: "Learn more about the imported accounts here.",
    copy: "Paste your private key string below:",
    forexample:
      "For example, 3a1076bf45ab87712ad64ccb3b10217737faacbf2872e88fdd9a537d8fe266",
  ...
  sendto: {
    ...
    nomoney:
      "Your account has {amount} {symbol} available to pay transaction fees. Buy some {symbol} or deposit it from another account.",
  ...
  mnemonic: {
    ...
    backupyourQRcodeinasafeenvironment:
      "Please back up your QR code in a safe environment Screenshot is not advised",
  ...
  createwallet: {
    ...
    title:
      "The password will be limited to unlocking your Erbie wallet on this device",
    password: "new password",
    password2: "confirm your password",
  ...
  createsuccessexchange: {
    ...
    share:
      "You can also copy the link to share with friends, invite friends to come to visit ~",
  },
  addCurrency: {
  ...
  createExchange: {
    ...
    namemessagelength:
      "The length of the staker name needs to be more than 4 characters",
    amount: "Amount",
    close: "Close",
    cancel: "Cancel",
    confirm: "Confirm",
    ...
    create_wrong:
      "I'm very sorry, because of some accident, the operation failed, you can go to the transaction history to check the specific information of the transaction",
    tradeTit: "Confirm Information",
    close_approve:
      "The request is being unfrozen. You can also view the details of the request through the transaction history",
    close_waiting:
      "Unfreezing the pledge for you. This process may take a few seconds",
    close_success:
      "The pledge has been successfully unfrozen for you, the pledged amount has been returned to your account, you can also view the details of the transaction through the transaction history",
    close_wrong:
      "I'm very sorry, because of some accident, the operation failed, you can go to the transaction history to check the specific information of the transaction",
    formCharge: "Commission Charge",
    commission:
      "This is the {value}% fee your staker will charge sellers who transact on your staker.",
    ...
    snft: "SNFT",
    desc1:
      "You can stake your CSBT to have a chance to get rewards when a new block is created.",
    desc2: "Click this button to redeem your staked CSBT.",
    exchange: "Staker",
    ...
    pageTip:
      'This is the Staker management page.If you want to go to Staker\'s page ,click on "Exchange".If you want to he exchange\'s console,click on "console".If you want to add the stake amount or redeem your staking,click on "Staking & Redemption".If you want to change the setting of server,Click on "Server".',
    ...
    serveTip3:
      "This is the using time of our server you bought for this transaction",
    addStaking:
      "The transaction will help you stake addtional ERBs into your accounts.Your chance of getting rewards will be increased.Your additional ERBs will also can be redeemed after months。",
    redeem: "This is the amount of ERB you want to redeem",
    convert: "Convert",
    desc3:
      "This the button that you can convert your SNFT to ERB with Erbie Blockchain.",
    insufficientMoney:
      "After staking ,your balance will be less than 201 ERB wihich is not enough to set up your market on our server.You will need to get extra {value} ERB.",
  },
  createAccountpage: {
    ...
    userAgreement: "I have read and accept Erbie the Terms of Service",
    ...
    back: "Back",
    next: "Next",
    serviceandPrivacyNotice:
      "Please review the Erbie ERB Wallet Terms of Service and Privacy Notice.",
    memErr: "The secret recovery format is wrong, please confirm and resubmit",
    isServiceandPrivacyNotice:
      "Please make sure to checkmthe Terms of Service and Privacy Notice. ",
  ...
  validator: {
    ...
    pledgeAmountErr: "The amount pledged cannot be less than 350 ERB",
    pledgeAmountErr1: "The amount pledged must be greater than 0",
    redemAmountErr:
      "The redemption amount cannot be greater than the amount pledged",
    redemAmountErr2: "The redemption amount cannot be empty",
    redemAmountErr3: "The redemption amount must be greater than 0",
    fromPledgeErr: "The current address to pledge must be greater than 350",
    updateLoadingText: "Data uploading...",
    leftPledgeErr:
      "The minimum pledge amount is 350ERB and you can choose to redeem the entire pledge amount",
    ...
    ownValidatorTip:
      "Validators need to stake a minimum of 350 ERB to their own address to become qualified full nodes, and the more they stake, the higher their weight will be.",
    otherValidator: "Other validator addresses",
    otherValidatorTip:
      "Stakers can participate in SNFT mining by staking ERB either with validators who have high online weights or with specified validators.",
  ...
  closeexchange: {
    ...
    shutitdown:
      "Are you sure you want to shut it down?You will be refunded the ${data} pledge.",
  ...
  minerspledge: {
    smileTip:
      "Your credibility is good, {value}, please keep it and get more income. {btn}",
    sadTip:
      "Your credibility is lower than 70, click the button on the right to recovery it. {btn}",
    neutralTip:
      "Your credibility is lower than 70, click the button on the right to recovery it. {btn}",
    homeTip:
      "Your Credibility is lower than 70, increase your Credibility to gain higher income. {btn}",
    noMoney:
      "Please make sure your account balance is over {value} so that you can recover credibility successfully.",
    resetSendTip:
      "By credibility recovery，your credibility can be recovered to maximum.One credibility will cost one ERB.",
    gotIt: "Got it >",
    resetBtnTip:
      "With this button，you can recover your credibility to 70 credibility will cost {value} ERB. The ERB cost will be burnt by Erbie block chain.",
    ...
    create_approve:
      "In a pledge request, you can also view the details of the request through the transaction history",
    create_waiting:
      "The pledge is being made for you. This process may take more than ten seconds",
    create_success:
      "The pledge has been successfully made for you. You can also view the details of the transaction through the transaction history",
    create_wrong:
      "I'm very sorry, because of some accident, the operation failed, you can go to the transaction history to check the specific information of the transaction",
    ...
    stackTip:
      "Tips: The pledge period is one year. Please check the terms and regulations for details.",
    isPoor:
      "Tips：Your account is short of assets. Please make sure you have enough money in your wallet.",
    ...
    stackingTip:
      "This is the estimated annual income after the additional staking done",
    select: "Select",
    selectErb:
      "Tips：Select ERB. Your pledge income will be returned in the form of ERB.",
    selectSnft:
      "Tips：Select SNFT. Your pledge income will be returned in the form ofSNFT.",
    ...
    minus_approve:
      "We are approving your  stake redeption request.You may have to wait for seconds.You can also find the details in transaction history.",
    minus_waiting:
      "We are doing the stake redeption.Please wait for  a minute.",
    minus_success:
      "Your stake redeption has been done.You can find the details in transaction history.",
    minus_wrong:
      "I'm very sorry, because of some accident, the operation failed, you can go to the transaction history to check the specific information of the transaction",
  },
  returnreceipt: {
  ...
  createminerspledge: {
    ...
    stake: "Staking",
    stakeTip:
      "This is the staking amount which is already staked in this account",
    yield: "yield",
    custom: "Custom",
    confirmationof: "Confirmation of",
    termsAndConditions: "Terms & Conditions",
    ...
    balance: "Balance:",
    congratulations:
      " Congratulations, the modification is successful,Congratulations, the node is correct.",
  ...
  transaction: {
    ...
    addressErrMsg:
      "The receiving address and the sending address cannot be the same",
  },
  networklist: {
  ...
  addtokens: {
    title:
      "Be careful of fake versions of existing tokens. Visit{wormholesLink}to learn more.",
    ...
    import: "Import",
    tokenImportTip:
      "You have not held the ERC20 token, are you sure to import it?",
  },
  sendNft: {
  ...
  receiveRewards: {
    ...
    tiptit3: "Get ERBs:",
    tip1: "CSBT obtained during the official Erbie event will be displayed on this page. You can click the “claim” button to get all the CSBT in one click, and the CSBT will be deposited directly into your current wallet.{br}You can operate your right and interests through the NFT trading centre in the lower right corner.",
  ...
  bourse: {
    ...
    vainame2:
      "It is 4-20 in length and supports Chinese and English and numbers    ",
    ...
    tip11:
      "Directly click the arrow to access! Copy or share this link with a friend who will be able to access it.",
    ...
    custom: "Custom",
    tip13:
      "If you do not use our service, after staking your ERB to open an  NFT Staker, you will need to follow the wiki instructions to set up your NFT Staker on your own server.",
    tip14:
      "After paying the 200 ERB server fee, your NFT Staker will go online immediately.",
    tip15:
      "Tips：Your account is short of assets. Please make sure you have enough money in your wallet.",
    ...
    tip17:
      "Here is the meaning of the text，Here is the meaning of the textHere is the meaning of the textHere is the meaning of the text…",
    cms: "Exchange & CMS",
    settingExchange: "Setting of the Exchange",
    tip18: "Staking & Server & Closing of the Exchange",
    tip19:
      "Tips：If you continue to perform this operation, you will not be able to obtain subsequent benefits.",
    closeSuccess: "Close the success",
    minusTit: "Staking Redemption",
    addTit: "Staking Additional",
    serverFee: "Server Fee",
    minusStaking:
      "After you redeem 350 ERB, you will have nochance to earn SNFT rewards again.",
    period: "Server Period Remaining",
    addServeAmount:
      "You can rent our server to host your staker for 200 ERB a year. Afer paying, your staker will be hosted on our server.",
    ...
    tipincome:
      "This is the estimated annual profit you will receive after redemption.",
  ...
  error: {
    ...
    timeout:
      "Network is busy at this moment.The transaction has been put into the queue,please wait for a moment and do not send same tranactions.",
