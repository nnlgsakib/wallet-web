<template>
  ...
  <div class="page-send-link">
    ...
    <div>
      <div class="pl-20 pr-20">
        <a class="send-link-a" :href="sendLink" target="_blank" rel="noopener noreferrer">{{ sendLink }}</a>
      </div>
    </div>
  </div>
  <div class="btn-group">
  ...
  <div class="code-inner">
    <transition name="fade">
      <div class="code-mask flex center" v-if="codeShow" @click="codeShow = false">
        <div class="code-box">
          ...
          <div class="code-ele flex center">
            <qrcode-vue :value="codeData" class="code" :size="230" level="L" ref="coderef"></qrcode-vue>
          </div>
        </div>
      </div>
    </transition>
  ...
  <dialog-warning v-model:isWarning="isWarning" :text="t('receive.copyTip')" iconName="checked" color="#3AAE55">
  </dialog-warning>
</template>
