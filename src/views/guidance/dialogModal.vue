<template>
  <div>
    <div>
      <van-dialog v-model:show="showModal" teleport="#page-box" class="techniqueAssistant-modal" :showConfirmButton="false" :showCancelButton="false" closeOnClickOverlay :before-close="dispatchClose" :title="''">
    ...
    <div>
      <van-dialog v-model:show="showModal2" teleport="#page-box" class="startGuideModal" :showConfirmButton="false" :showCancelButton="false" closeOnClickOverlay :title="''">
