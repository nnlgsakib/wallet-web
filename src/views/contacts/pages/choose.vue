<template>
  ...
  <div class="contacts-list">
    <div class="list">
      ...
      <van-tabs shrink sticky offset-top="48">
            ...
            <van-sticky offset-top="94" v-if="contacts3.length">
              <div class="sort-box flex right center-v">
                <span class="sort-icon flex center" @click="toggleSort(3)">
                  <svg t="1652000398657" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="27331" width="16" height="16">
                    <path d="M278.74 206l-1.57 1.57V206h1.57zM315.07 101l-1.57 1.57V101h1.57z" :fill="sortType3 == '1' ? '#9F54BA' : '#909090'" p-id="27332"></path>
                    <path d="M455.22 873.05h-61.74V151.63h61.74z" :fill="sortType3 == '1' ? '#9F54BA' : '#909090'" p-id="27333"></path>
                    <path d="M209.16 424.58v-87.31l184.33-184.32 1.28-1.29 43.66 43.65-44.94 44.95-184.33 184.32z" :fill="sortType3 == '1' ? '#9F54BA' : '#909090'" p-id="27334"></path>
                    <path d="M568.11 151.62h61.74v721.42h-61.74z" :fill="sortType3 == '1' ? '#909090' : '#9F54BA'" p-id="27335"></path>
                    <path d="M814.17 600.09v87.31L629.85 871.72l-1.29 1.29-43.66-43.66 44.95-44.94 184.32-184.32z" :fill="sortType3 == '1' ? '#909090' : '#9F54BA'" p-id="27336"></path>
                  </svg>
                </span>
              </div>
            </van-sticky>

            <ContactsList :indexList="indexList3" :contacts="contacts3" :offsetTop="46" />
          </div>
          <no-data v-else />
        </van-tab>
            ...
            <van-sticky offset-top="94" v-if="contacts2.length">
              <div class="sort-box flex right center-v">
                <span class="sort-icon flex center" @click="toggleSort(2)">
                  <svg t="1652000398657" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="27331" width="16" height="16">
                    <path d="M278.74 206l-1.57 1.57V206h1.57zM315.07 101l-1.57 1.57V101h1.57z" :fill="sortType2 == '1' ? '#9F54BA' : '#909090'" p-id="27332"></path>
                    <path d="M455.22 873.05h-61.74V151.63h61.74z" :fill="sortType2 == '1' ? '#9F54BA' : '#909090'" p-id="27333"></path>
                    <path d="M209.16 424.58v-87.31l184.33-184.32 1.28-1.29 43.66 43.65-44.94 44.95-184.33 184.32z" :fill="sortType2 == '1' ? '#9F54BA' : '#909090'" p-id="27334"></path>
                    <path d="M568.11 151.62h61.74v721.42h-61.74z" :fill="sortType2 == '1' ? '#909090' : '#9F54BA'" p-id="27335"></path>
                    <path d="M814.17 600.09v87.31L629.85 871.72l-1.29 1.29-43.66-43.66 44.95-44.94 184.32-184.32z" :fill="sortType2 == '1' ? '#909090' : '#9F54BA'" p-id="27336"></path>
                  </svg>
                </span>
              </div>
            </van-sticky>
            <ContactsList :indexList="indexList2" :contacts="contacts2" :offsetTop="46" />
          </div>
          <no-data v-else />
        </van-tab>
      </van-tabs>
