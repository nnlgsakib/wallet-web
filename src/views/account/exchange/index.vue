      ...
      <div class="miners-container flex column between">
        <div>
          ...
          <div class="contaienr-top-ipt">
            ...
            <van-field class="user-field" v-model="name" :placeholder="t('createExchange.stockexchange')" :rules="[{ required: true, message: t('createExchange.stockexchange') }]" />
            <div class="stake">
        ...
        <div class="container-btn flex center column">
          ...
          <div>
            ...
            <van-button type="primary" class="btn" round @click="minersConfirm" :disabled="accountInfo.amount == 0">{{ $t('createExchange.confirm') }}</van-button>
          </div>
        </div>
      </div>
    </div>
